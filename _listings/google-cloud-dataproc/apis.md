...
created: "2018-02-25"
modified: "2018-02-25"
url: https://raw.githubusercontent.com/streamdata-gallery/database/master/_listings/google-cloud-dataproc/apis.yaml
...
- name: Google Cloud Dataproc API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/database/master/_listings/google-cloud-dataproc/v1-name-cancel-post.md
x-common:
- type: x-change-logs
