...
created: "2018-02-25"
modified: "2018-02-25"
url: https://raw.githubusercontent.com/streamdata-gallery/database/master/_listings/google-cloud-spanner/apis.yaml
...
- name: Google Cloud Spanner API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/database/master/_listings/google-cloud-spanner/v1-session-streamingread-post.md
x-common:
- type: x-change-log
